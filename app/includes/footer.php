<div class="contenedor-footer">
    <div class="contenido-footer">
        <div class="logo-footer footer-content division-der">
            <img src="img/logo.png" alt="">
        </div>
        <div class="sep-down"></div>
        <div class="sep-der"></div>
    ...
    <div class="contenido-footer separacion-top">
        <p>© 2021 LeviatanGG. Todos los derechos reservados.</p>
    </div>
</div>