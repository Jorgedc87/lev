											...
											<div class="notify-wrap ">
												<form id="notifyMe" class="contact-form" action="notify-me.php" method="post">
													<div class="input-wrap">
														...
														<button type="submit"  class="btn btn-default progress-button btn-submit">Notify me
								...
								<div class="tablecell align-middle">
									<section class="timer-sec">
										...
										<div class="clock-wrap">
											...
											<switch>
												<g>
													<circle fill="none" stroke="#000" stroke-miterlimit="10" cx="40.5" cy="40.5" r="40"/>
													<circle fill="#000" cx="40.5" cy="40.5" r="2.806"/>
													<line id="min" fill="none" stroke="#000" stroke-width="2" stroke-miterlimit="10" x1="40.5" y1="10.5" x2="40.5" y2="40.5"/>
													<line id="hour" fill="none" stroke="#000" stroke-width="1.5" stroke-miterlimit="10" x1="40.5" y1="20.5" x2="40.5" y2="40.5"/>
													<line id="sec" fill="none" stroke="#000" stroke-miterlimit="10" x1="40.5" y1="7.5" x2="40.5" y2="40.5"/>
												</g>
											</switch>
											</svg>
										</div>
									...
									<section class="intro-text">
										...
										<h2>We build tools for creative people.</h2>	
										<div class="clearfix"></div>
									</section>
									<!--/main content-->
								</div>
								 ...
								 <div class="project-gallery row" itemscope itemtype="http://schema.org/ImageGallery">
									<figure class="col-sm-6 margin-btm-xs" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
									  <a href="img/project1.jpg" itemprop="contentUrl" data-size="730x490">
										...
										<figcaption itemprop="caption description">Title One	</figcaption>
									...
									<figure class="col-sm-6 margin-btm-xs" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
									  <a href="img/project2.jpg" itemprop="contentUrl" data-size="730x490">
										...
										<figcaption itemprop="caption description">Title Two</figcaption>
									</figure>
									<figure class="col-sm-6 margin-btm-xs" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
									  <a href="img/project3.jpg" itemprop="contentUrl" data-size="730x490">
										...
										<figcaption itemprop="caption description">Title Three</figcaption>
									</figure>
									<figure class="col-sm-6" itemprop="associatedMedia" itemscope itemtype="http://schema.org/ImageObject">
									  <a href="img/project4.jpg" itemprop="contentUrl" data-size="730x490">
										...
										<figcaption itemprop="caption description">Title Four
										</figcaption>
									</figure>
								</div>
							</div>
							...
							<div class="row">
								<div class="address-detail">
									...
									<div class="col-sm-4 margin-btm-xs">
										...
										<span>reach</span>
										<a href="mailto:hello@Hencework.com" target="_blank">inquiry@Popeye.com</a>
									</div>
